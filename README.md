...
Optimized and modified command.go, referencing some commands commonly used in hacker attacks to make the SSH honeypot more realistic. 

Now supports commands such as uname -a, ifconfig, cat /proc/cpuinfo.

TODO: Support pipeline operations in SSH
